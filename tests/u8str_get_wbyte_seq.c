...
int main(int argc, char *argv[]) {
    ...
    assert(u8str_get_wbyte_seq(&a[0], &w_a) == 4);
    ...
    assert(u8str_get_wbyte_seq(&b[0], &w_b) == 3);
    ...
    assert(u8str_get_wbyte_seq(&c[0], &w_c) == 2);
    ...
    assert(u8str_get_wbyte_seq(&d[0], &w_d) == 1);
    ...
    assert(w_e == 42069);
    assert(!u8str_get_wbyte_seq(&e[0], &w_e));
